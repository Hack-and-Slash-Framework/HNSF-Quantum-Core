...
public class AddressablesGamemodeDefinition : BaseGamemodeDefinition
{
    ...
    {
        if (gamemodeSettingsHandle.IsValid() == false || gamemodeSettingsHandle.Status != AsyncOperationStatus.Succeeded) return null;
    ...
    {
        if(gamemodeMatchHandlerHandle.IsValid() && gamemodeMatchHandlerHandle.Status == AsyncOperationStatus.Succeeded)
