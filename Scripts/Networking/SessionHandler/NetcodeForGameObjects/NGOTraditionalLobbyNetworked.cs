...
namespace HnSF.sessionhandling.handlers.NGO
{
    public partial class NGOTraditionalLobbyNetworked : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            {
                RegisterClientPlayersRpc(NetworkManager.LocalClient.ClientId, HnSFManagersContainer.instance.inputManager.GetPlayerCount(), $"Hosting Player");
            }
        }
        ...
        private void OnConnectionEvent(NetworkManager networkManager, ConnectionEventData connectionEventData)
        {
            ...
            switch (connectionEventData.EventType)
            {
                case ConnectionEvent.ClientConnected:
                    ...
                    {
                        RegisterClientPlayersRpc(networkManager.LocalClient.ClientId, HnSFManagersContainer.instance.inputManager.GetPlayerCount(), $"{Random.Range(0, 1000)}");
                    }
                    break;
