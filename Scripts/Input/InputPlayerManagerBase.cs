...
{
    public class InputPlayerManagerBase : MonoBehaviour
    {
        ...
        public delegate void DelegateWhenControlSchemeChanged(InputPlayerManagerBase inputPlayer,
        ...
        public virtual void SwitchToUIMap()
        {
        ...
        public virtual void SwitchToPlayerMap()
        {
        ...
        public virtual InputManager.ControlSchemeType GetCurrentDeviceType()
        {
