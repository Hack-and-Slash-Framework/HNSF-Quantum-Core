...
namespace HnSF.ui.menus.examples.mainmenu
{
    public class LocalMatchScreenHandler : MenuHandlerBase
    {
        ...
        {
            var gameManager = HnSFManagersContainer.instance;
            if(screenContentPicking == null) screenContentPicking = HnSFManagersContainer.instance.genericContentPickerInstanceManager.CreateInstance<BaseGamemodeDefinition>(transform);
