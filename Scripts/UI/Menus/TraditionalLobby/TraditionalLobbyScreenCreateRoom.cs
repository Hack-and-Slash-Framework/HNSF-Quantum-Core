...
namespace HnSF.ui.menus.traditionallobby
{
    public class TraditionalLobbyScreenCreateRoom : MenuHandlerAndMenuBase
    {
        ...
        {
            screenContentPicking = HnSFManagersContainer.instance.genericContentPickerInstanceManager.CreateInstance<BaseGamemodeDefinition>(transform);
        ...
        {
            screenContentPicking = HnSFManagersContainer.instance.genericContentPickerInstanceManager.CreateInstance<IMapDefinition>(transform);
