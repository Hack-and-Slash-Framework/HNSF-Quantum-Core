...
namespace HnSF
{
    ...
    {
        public static DevicePickerUtility instance;
        ...
        public void Open(int minimumPlayers = 0, int maximumPlayers = 4)
        {
            ...
            inputManager = InputManager.instance as InputManager;
        ...
        public void Close()
        {
            var systemPlayer = inputManager.GetSystemPlayer() as InputPlayerManager;
