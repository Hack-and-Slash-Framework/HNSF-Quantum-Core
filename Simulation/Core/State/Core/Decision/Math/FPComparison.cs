...
{
    [Serializable]
    public unsafe partial class FPComparison : HNSFStateDecision
    {
        ...
        public HNSFParamFP paramA;
        public HNSFParamFP paramB;
        ...
        {
            return CopyTo(new FPComparison());
        }

        public override HNSFStateDecision CopyTo(HNSFStateDecision target)
        {
            var t = target as FPComparison;
            t.checkType = checkType;
            t.paramA = paramA.Clone() as HNSFParamFP;
            t.paramB = paramB.Clone() as HNSFParamFP;
