...
{
    [Serializable]
    public unsafe partial class RequestStateChange : HNSFStateAction
    {
        [Serializable]
        public class StateChangeEntry
        {
            ...
            public AssetRef<HNSFState> toState;
        ...
        private void DoAction(Frame frame, EntityRef entity, ref HNSFStateContext stateContext)
        {
            ...
            {
                stateContext.workingState = entry.toState;
                ...
                if (!frame.TryFindAsset(entry.toState.Id, out HNSFState toState)) continue;
                ...
                stateContext.agentData->toState = entry.toState;
        ...
        {
            return CopyTo(new RequestStateChange());
        }

        public override HNSFStateAction CopyTo(HNSFStateAction target)
        {
            var t = target as RequestStateChange;
            if (stateChangeList == null) stateChangeList = Array.Empty<StateChangeEntry>();
            ...
            for (int i = 0; i < stateChangeList.Length; i++)
            {
                ...
                if (stateChangeList[i].condition == null) stateChangeList[i].condition = Array.Empty<HNSFStateDecision>();
                ...
                t.stateChangeList[i].toState = stateChangeList[i].toState;
                ...
                t.stateChangeList[i].checkToStateInputCondition = stateChangeList[i].checkToStateInputCondition;
