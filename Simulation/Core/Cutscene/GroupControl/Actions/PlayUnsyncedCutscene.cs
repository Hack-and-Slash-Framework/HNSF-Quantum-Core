...
{
    [Serializable]
    public unsafe partial class PlayUnsyncedCutscene : GroupControlAction
    {
...
namespace HnSF.core.GroupControl.Nodes
{
    ...
    internal class PlayUnsyncedCutscene : ActorGroupControlNode
    {
        ...
        public override GroupControlAction Convert()
        {
            ...
            return new Actions.PlayUnsyncedCutscene()
            {
                cutsceneSourceTag = cutsceneSourceTag,
                cutsceneTag = cutsceneTag
            };
