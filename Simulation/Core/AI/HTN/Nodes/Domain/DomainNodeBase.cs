...
namespace HnSF.core.AI.HTN.Domain
{
    ...
    public abstract class DomainNodeBase : HnSF.Nodes.NodeBase
    {
        ...
        protected override void OnDefineOptions(IOptionDefinitionContext context)
        {
            ...
            context.AddOption<string>(OPTION_LABEL).WithDisplayName("Label").Build();
        }
        ...
        {
            GetNodeOptionByName("Weight").TryGetValue(out int weight);
            return weight;
        }
