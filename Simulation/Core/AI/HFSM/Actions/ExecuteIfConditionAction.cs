...
namespace Quantum
{
    ...
    public unsafe partial class ExecuteIfConditionAction : AIAction
    {
        ...
        public override void Execute(Frame frame, EntityRef entity, ref AIContext aiContext)
        {
            ...
            ConditionalExecute(frame, entity, ref aiContext, uData, aiConfig);
        }

        public virtual void ConditionalExecute(Frame frame, EntityRef entity, ref AIContext aiContext, AIContextUser* user, AIConfigBase aiConfig)
        {
