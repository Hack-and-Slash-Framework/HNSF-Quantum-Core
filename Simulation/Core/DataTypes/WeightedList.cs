...
using UnityEngine;
using static HnSF.WeightErrorHandlingType;
...
namespace HnSF
{
    ...
    public unsafe class WeightedList<T> : IEnumerable<T>
    {
        ...
        /// </summary>
        public WeightedList(IEnumerable<T> listItems, Func<T, int> getWeight)
        {
        ...
        /// <summary>
        /// Create a WeightedList with the provided items.
        /// </summary>
        ...
        [SerializeField] private List<int> _weights = new();
        [SerializeField] private List<int> _probabilities = new();
        [SerializeField] private List<int> _alias = new();
        [SerializeField] private int _totalWeight;
        [SerializeField] private bool _areAllProbabilitiesIdentical = false;
