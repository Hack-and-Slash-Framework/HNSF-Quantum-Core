...
namespace HnSF.core.GroupControl.Functions
{
    public unsafe partial class GroupControlFunction
    {
        ...
        {
            public override List<byte> Execute(Frame frame, EntityRef infoEntityRef, ref BattleScriptContext context)
            {
                return null;
            }
        }
        ...
        {
            public override List<int> Execute(Frame frame, EntityRef infoEntityRef, ref BattleScriptContext context)
            {
                return null;
            }
        }
        ...
        {
            public override List<long> Execute(Frame frame, EntityRef infoEntityRef, ref BattleScriptContext context)
            {
                return null;
            }
        }
        ...
        {
            public override List<FP> Execute(Frame frame, EntityRef infoEntityRef, ref BattleScriptContext context)
            {
                return null;
            }
        }
